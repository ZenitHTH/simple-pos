  ...
  return (
    ...
    >
        ...
        <div className="sticky top-10 space-y-6">
          <motion.div variants={item}>
            ...
            <p className="text-muted-foreground text-lg">
              Adjust the layout, spacing, and typography of the main navigation
              sidebar.
            </p>
          </motion.div>
          <SidebarStylesPanel
          ...
          >
            <strong>Tip:</strong> The width scale affects the overall sidebar
            footprint, while icon size and spacing fine-tune the internal item
            density.
          </motion.div>
        </div>
      </div>
      ...
      <motion.div variants={item} className="space-y-6 lg:col-span-2">
        <div className="border-border/60 bg-card/30 relative flex h-[600px] overflow-hidden rounded-3xl border shadow-xl backdrop-blur-sm">
          {/* Mock Sidebar Container */}
          <div
            className="border-border bg-card flex h-full flex-col border-r transition-all duration-300"
            style={{
          ...
          >
            <div className="p-6">
              <div className="bg-primary/20 h-8 w-24 rounded-lg" />
            </div>
          ...
          <div className="bg-background flex-1 p-8">
            <div className="bg-muted mb-6 h-8 w-1/3 rounded-lg" />
            <div className="space-y-4">
              <div className="bg-card border-border h-32 w-full rounded-2xl border" />
              <div className="bg-card border-border h-32 w-full rounded-2xl border" />
            </div>
          </div>
        </div>
