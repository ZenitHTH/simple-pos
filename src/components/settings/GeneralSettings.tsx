...
const GeneralSettings = memo(
  function GeneralSettings({}: GeneralSettingsProps) {
    ...
    const onUpdateSettings = useCallback(
      (updates: DeepPartial<AppSettings>) => {
    ...
    const handleResetStorage = async () => {
      ...
      try {
        ...
        const dbDir = storageInfo.db_path.substring(
          0,
          storageInfo.db_path.lastIndexOf("/"),
        );
      ...
      <SettingsSection title="General Settings" icon={FaCog}>
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-2">
            <h4 className="text-sm font-bold tracking-wider uppercase opacity-60">
              Image Storage
            </h4>
          ...
          <div className="border-border space-y-2 border-t pt-4">
            ...
            <div className="bg-warning/10 text-warning border-warning/20 rounded-lg border p-2 text-[10px] leading-tight">
              <strong>RESTART REQUIRED:</strong> Changing this requires moving
              'database.db' manually.
            </div>
            <div className="flex items-center gap-2">
              <div className="bg-muted/30 border-border flex-1 truncate rounded-lg border px-3 py-2 font-mono text-xs">
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  if (selected && typeof selected === "string")
                    onUpdateSettings({
                      storage: { db_storage_path: selected },
                    });
                }}
              >
                Browse
              ...
              {dbStoragePath && (
                <Button
                  ...
                  onClick={() =>
                    onUpdateSettings({
                      storage: { db_storage_path: undefined },
                    })
                  }
                >
                  Reset
