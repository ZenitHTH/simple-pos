...
const DisplaySettings = memo(() => {
  ...
  return (
    <SettingsSection title="Display & Interface" icon={FaDesktop}>
      ...
      <div className="bg-muted/10 border-border/50 mb-6 rounded-2xl border p-6 transition-[background-color] hover:bg-muted/20">
      ...
      <div className="bg-muted/10 border-border/50 rounded-2xl border p-6 transition-[background-color] hover:bg-muted/20">
        ...
        <button
          ...
          className="bg-zinc-900 hover:bg-zinc-800 text-zinc-100 border-zinc-700/50 group flex w-full items-center justify-center gap-3 rounded-xl border py-4 text-xs font-black tracking-[0.2em] uppercase shadow-xl transition-[background-color,transform,box-shadow] active:scale-[0.98]"
        >
