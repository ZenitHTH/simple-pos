  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      <button
        ...
        className="bg-secondary hover:bg-secondary/80 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl text-xl font-bold transition-[background-color,transform,opacity] duration-200 will-change-transform active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
        disabled={value <= min}
      >
        −
      </button>
