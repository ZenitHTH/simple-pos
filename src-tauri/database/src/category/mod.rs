...
pub fn insert_category(conn: &mut SqliteConnection, new_category: &NewCategory) -> QueryResult<Category> {
...
pub fn update_category(conn: &mut SqliteConnection, category_data: Category) -> QueryResult<Category> {
